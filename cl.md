...
- 最终源码提交和 APK `versionName` 均为 `0659733b`，`versionCode=102`、`primaryCpuAbi=arm64-v8a`；APK v1/v2 签名有效，平台证书 SHA-256 为 `c8a2e9bccf597c2fb6dc66bee293fc13f2fc47ec77bc6b2b0d52c11f51192ab8`。
- 最终 Release 位于 `fcitx5-android/build/kboard.apk`，APK SHA-256 为 `5462203f501e5a03517c0867b3f96045dd395f324a7f96fdeafc60acca9fc844`；覆盖安装到 `192.168.3.63:5555` 返回 `Success`。
...
### 待办
- 遵照用户“自己测试、只推送”的要求，最终 `0659733b` 没有由 ADB 启动输入法或自动触摸；连续尾幕和 C 型转身在 Mali-G52 上的 Shader 运行结果与实际观感由用户现场确认，Release 编译成功不能替代该项验收。
